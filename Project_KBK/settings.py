"""
Django settings for Project_KBK project.
...
SECRET_KEY = 'django-insecure-5nrmk9ucv1&w@e6qy@0)8&bk$*tgc(_v2gmzp)vm(k@yu%pqy_'
...
WSGI_APPLICATION = 'Project_KBK.wsgi.application'
